#
#  Be sure to run `pod spec lint MediaMathSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "mmacdermaid"
  # s.authors            = { "mmacdermaid" => "mmacdermaid@mediamath.com" }
  # s.social_media_url   = "http://twitter.com/mmacdermaid"
  ...
  s.source       = { :git => "http://mmacdermaid/sdkpublic.git", :tag => "0.0.1" }
